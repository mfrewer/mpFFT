...
#include "serial_mp_fft3.c"
#elif CODE==1
#define FFT mp_sr24_cp_fft(N,1,0,inr,ini,outr,outi);
#include "serial_mp_fft1.c"
#elif CODE==2
#define FFT mp_sr24_cp_fft(N,1,0,inr,ini,outr,outi);
#include "serial_mp_fft2.c"
#elif CODE==3
#define FFT mp_sr24_cp_fft(N,1,0,inr,ini,outr,outi);
#include "serial_mp_fft3.c"
#elif CODE==4
#define FFT mp_sr24_cp_fft_v2(N,0,1,0,inr,ini,outr,outi);
#include "serial_mp_fft4.c"
#endif
