...
#undef CODE
#define CODE 7
#define FFT d_sr24_cp_fft_v2(N,0,1,0,inr,ini,outr,outi);
#include "serial_d_fft7.c"
#elif CODE==1
#define FFT d_sr24_fft(N,1,inr,ini,outr,outi);
#include "serial_d_fft1.c"
#elif CODE==2
#define FFT d_sr24_fft(N,1,inr,ini,outr,outi);
#include "serial_d_fft2.c"
#elif CODE==3
#define FFT d_sr24_fft(N,1,inr,ini,outr,outi);
#include "serial_d_fft3.c"
#elif CODE==4
#define FFT d_sr24_fft_v2(N,0,1,inr,ini,outr,outi);
#include "serial_d_fft4.c"
#elif CODE==5
#define FFT d_sr24_cp_fft(N,1,0,inr,ini,outr,outi);
#include "serial_d_fft5.c"
#elif CODE==6
#define FFT d_sr24_cp_fft(N,1,0,inr,ini,outr,outi);
#include "serial_d_fft6.c"
#elif CODE==7
#define FFT d_sr24_cp_fft_v2(N,0,1,0,inr,ini,outr,outi);
#include "serial_d_fft7.c"
#endif
